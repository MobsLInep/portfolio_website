...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitError(
        "Something went wrong sending your message. Please try again, or email me directly at shreyanshoct@gmail.com."
      );
    } finally {
      setSubmitting(false);
    }
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-white flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center min-w-[44px] min-h-[44px] -m-2 rounded-md text-gray-400 hover:text-primary transition-colors"
            ...
            >
              ...
              <div className="flex space-x-4">
                ...
                <motion.a
                  ...
                  className="socialContainer w-11 h-11 rounded-md flex items-center justify-center overflow-hidden transition-colors duration-300 hover:bg-[#0077B5]"
                >
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="socialContainer w-11 h-11 rounded-md flex items-center justify-center overflow-hidden transition-colors duration-300 hover:bg-[#1F8ACB]"
                >
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="socialContainer w-11 h-11 rounded-md flex items-center justify-center overflow-hidden transition-colors duration-300 hover:bg-[#333]"
                >
                  <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current text-white">
                ...
                <motion.a
                  ...
                  className="socialContainer w-11 h-11 rounded-md flex items-center justify-center overflow-hidden transition-colors duration-300 hover:bg-[#D44638]"
                >
                  <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current text-white">
              ...
              >
                ...
                {submitError && (
                  <motion.div
                    ...
                    role="alert"
                    aria-live="assertive"
                    className="flex items-start gap-2 rounded-md border border-accent/60 bg-accent/10 px-4 py-3 text-sm text-accent-light"
                  >
                ...
                <motion.div variants={itemVariants}>
                  <button
                    type="submit"
                    disabled={submitting}
                    className="inline-flex items-center gap-2 bg-primary hover:bg-primary-dark text-background px-6 py-3 rounded-md transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                  >
